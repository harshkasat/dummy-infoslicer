...
class RawSentence:
    ...
    def __init__(self, idz, source_article_id, source_section_id, source_paragraph_id, source_sentence_id, buf, formatting, leftmark, rightmark):
        self.idz = idz
    ...
    def getData(self):
        ...
        data = SentenceData(id, source_article_id, source_section_id, source_paragraph_id, source_sentence_id, text, formatting)
        return data
        ...
        if text == "":
            ...
            for line in lines:
                if line == "":
                    ...
                    sentences.append(RawSentence(self.idz, self.source_article_id, self.source_section_id, self.source_paragraph_id, self.source_sentence_id, self.buf, self.formatting, startmark, endmark))
        ...
        if self.getEnd().compare(nextiter) == 0:
            return [self]
             ...
             if self.getEnd().compare(nextiter) > 0: 
                ...
                nextsentence = RawSentence(None, self.source_article_id, 1, 1, 1, self.buf, [], startmark, endmark)
